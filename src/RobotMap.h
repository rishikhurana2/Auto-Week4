...
constexpr double topBottomRed = 205.735;
constexpr double PinkBlue = 149;
constexpr double downPinkBlue = 19.56;
constexpr double RedDownwards = 221.12;
constexpr double Middle = 64;
constexpr double MiddleTopBottom = 36;
constexpr double MiddleTopBottomForward = 45;
